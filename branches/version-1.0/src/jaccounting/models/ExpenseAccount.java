/*
 * ExpenseAccount.java	    1.0.0	    09/2009
 * This file contains the expense account model class of the JAccounting application.
 *
...
/**
 * ExpenseAccount is the class for Account objects of type EXPENSE. An ExpenseAccount
 * represents an accounting expense/loss account where Debits increase its balance
