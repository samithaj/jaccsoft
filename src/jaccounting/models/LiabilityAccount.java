/*
 * LiabilityAccount.java	    1.0.0	    09/2009
 * This file contains the liability account model class of the JAccounting application.
 *
...
/**
 * LiabilityAccount is the class for Account objects of type LIABILITY. A LiabilityAccount
 * represents an accounting liability account where Debits decrease its balance
 * and Credits increase its balance.
 *
...
public class LiabilityAccount extends Account {
     ...
     * and sets its type to LIABILITY.
     *
     * @see		    Account#Account()
     * @since		    1.0.0
     */
...
>>>>>>> .r71
    ...
    /**
     * Applies a Debit amount to this Account's balance. This method decreases
